                        ...
                        <div class="pharm-account-group">
                                ...
                                <ul>
                                    <li>
                                        <a href="account.html" class="active">
                                            <div>
                                                <img src="{{ asset('frontend/assets/img/icons/account-icon-01.png') }}"
                                                    alt="Image">
                                                <p>Overview</p>
                                            </div>
                                        </a>
                            ...
                            <div class="account-overview">
                                ...
                                <p>From your account dashboard. you can easily check & view your <a
                                        href="{{ route('profile.myOrder') }}">recent orders</a>, manage your<a
                                        href="javascript:;">shipping and billing addresses</a> and <a
                                        href="change-password.html">edit your password and account details.</a></p>
                            </div>
                        </div>
                    </div>
                </div>
