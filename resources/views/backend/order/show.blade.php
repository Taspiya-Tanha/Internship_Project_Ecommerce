        ...
        <div class="row g-0">
            <div class="col-md-4 border-end">
                ...
                <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                    ...
                    <div class="col"><img src="" width="70"
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <div class="row">
                        <h4 class="card-title col-sm-9">{{ $order->title }}</h4>
                        <div class=" col-sm-3">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            {{-- {{ isset($product->subCategory->sub_name) ? $product->subCategory->sub_name : '' }}</dd> --}}
                        <dt class="col-sm-3">Price :</dt>
                        {{-- <dd class="col-sm-9">{{ isset($product->productPrice) ? $product->productPrice->price : ' ' }}</dd> --}}
                        <dt class="col-sm-3">Discount:</dt>
                        <dd class="col-sm-9">
                            {{-- {{ $product->productPrice ? $product->productPrice->discount : 'No Discount' }}</dd> --}}
