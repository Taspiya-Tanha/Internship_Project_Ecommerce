...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <p style="padding: 0.5rem; background-color:#0d6efd;color:white;">Delivery Person Create</p>
                    <form class="card-body" action="{{ route('delivery-boy.store') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="email" class="form-control" id="slug" name="email"
                                    value="{{ old('email') }}" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="number" class="form-control" id="image" name="phone"
                                    value="{{ old('phone') }}" />
                                @error('phone')
                                    <div style="color: red;">{{ $message }}</div>
                                @enderror
